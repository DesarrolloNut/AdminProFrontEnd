...
import { OrdenFabricacionDetalle } from '../../produccion/ordenfabricacion/models/OrdenFabricacionDetalle';
import { OrdenFabricacionVista } from '../../produccion/ordenfabricacion/models/OrdenFabricacionVista';

@Component({
  selector: 'app-ordenfabricacion-autorizacion',
  templateUrl: './ordenfabricacion-autorizacion.component.html',
  styleUrls: ['./ordenfabricacion-autorizacion.component.scss']
})
export class OrdenfabricacionAutorizacionComponent implements OnInit {
 ...
 devolucionSelected: OrdenFabricacionVista;
 CargandoDetalle: boolean;
 dataDetalle: OrdenFabricacionDetalle[];
 ...
 openModalDevolucionDetalle(content, DevolucionSelect: OrdenFabricacionVista) {
 ...
 getDataDetalle(DevolucionID:number) {
   ...
   this.httpService.DoPostAny<OrdenFabricacionDetalle>(DataApi.OrdenFabricacionDetalle, "GetOrdenFabricacionDetalleVistaByID", DevolucionID).subscribe(x => {
