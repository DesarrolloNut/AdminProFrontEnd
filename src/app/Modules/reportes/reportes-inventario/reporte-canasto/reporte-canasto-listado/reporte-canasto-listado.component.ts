...
export class ReporteCanastoListadoComponent implements OnInit {
  ...
  fecha: string = [new Date().getFullYear(), (new Date().getMonth() + 1), new Date().getDate()].join('-');
  ...
  getData() {
    ...
    this.httpService.GetAllWithPagination<ReporteCanasto>(DataApi.ReporteCanasto,
      "GetReporteCanastoListado", "TipoRutaId", this.paginaNumeroActual,
  ...
  exportarReporteExcel() {
    ...
    this.httpService.DoPost<ReporteCanasto>(DataApi.ReporteInventarioActivo,
  ...
  getTiposRutas() {
    ...
    this.httpService.DoPost<ComboBox>(DataApi.ComboBox,
      "GetRutaTipoComboBox", parametros).subscribe(response => {
