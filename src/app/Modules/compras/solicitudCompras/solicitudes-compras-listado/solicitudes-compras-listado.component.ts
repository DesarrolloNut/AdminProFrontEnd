...
export class SolicitudesComprasListadoComponent implements OnInit {
  ...
  data: SolicitudCompras[] = [] //tu modelo
  ...
  getData() {
    ...
    this.httpService.GetAllWithPagination<SolicitudCompras>(DataApi.SolicitudCompras, "GetSolicitudComprasListado", "ID", this.paginaNumeroActual,
