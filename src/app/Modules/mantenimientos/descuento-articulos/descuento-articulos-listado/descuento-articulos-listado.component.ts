...
@Component({
  selector: 'app-descuento-articulos-listado.component',
  templateUrl: './descuento-articulos-listado.component.html',
  styleUrls: ['./descuento-articulos-listado.component.scss']
})
export class DescuentoArticulosListadoComponent implements OnInit {
