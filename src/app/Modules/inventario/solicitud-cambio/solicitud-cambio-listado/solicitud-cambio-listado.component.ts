...
@Component({
  ...
  templateUrl: './solicitud-cambio-listado.component.html',
  styleUrls: ['./solicitud-cambio-listado.component.scss']
})
export class SolicitudCambioListadoComponent implements OnInit {
